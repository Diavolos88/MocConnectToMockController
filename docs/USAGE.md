...
- **Таймауты подключения** - настроены таймауты (2 сек на подключение, 3 сек на чтение), не блокируют работу
- **Ошибки при применении конфигурации** - логируются как ошибки, остальные поля применяются
